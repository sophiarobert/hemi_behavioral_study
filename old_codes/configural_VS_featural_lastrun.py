...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sophia/Documents/PycharmProjects/Local_VS_Global/configural_VS_featural_lastrun.py',
