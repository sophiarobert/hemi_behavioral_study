...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sophia/Documents/PycharmProjects/Local_VS_Global/test_lastrun.py',
...
while continueRoutine:
    ...
    if key_resp1.status == STARTED and not waitOnFlip:
        theseKeys = key_resp1.getKeys(keyList=['up', 'down'], waitRelease=False)
